...
pub fn createLibrary(sdk: *Sdk, linkage: std.build.LibExeObjStep.Linkage, formats: FormatSet, target: std.zig.CrossTarget, optimize: std.builtin.Mode) *std.build.LibExeObjStep {
...
pub fn addTo(sdk: *Sdk, target: *std.build.LibExeObjStep, linkage: std.build.LibExeObjStep.Linkage, formats: FormatSet) void {
    var lib = sdk.createLibrary(linkage, formats, target.target, target.optimize);
